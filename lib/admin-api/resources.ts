...
function cleanPayload<T extends Record<string, any>>(data: T): any {
  if (!data || typeof data !== "object") return data;
  const cleaned: Record<string, any> = {};
  for (const [k, v] of Object.entries(data)) {
    if (PROHIBITED_FIELDS.has(k)) continue;
    if (v !== undefined) {
      cleaned[k] = v;
    }
  }
...
export const blogPostsApi = {
  ...
  create: (data: StoreBlogPostRequest) => adminFetch<ApiResponse<BlogPostResource>>("/admin/blog-posts", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: UpdateBlogPostRequest) => adminFetch<ApiResponse<BlogPostResource>>(`/admin/blog-posts/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  patch: (id: number, data: Partial<UpdateBlogPostRequest>) => adminFetch<ApiResponse<BlogPostResource>>(`/admin/blog-posts/${id}`, { method: "PATCH", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const blogCategoriesApi = {
  ...
  create: (data: StoreBlogCategoryRequest) => adminFetch<ApiResponse<BlogCategoryResource>>("/admin/blog-categories", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: UpdateBlogCategoryRequest) => adminFetch<ApiResponse<BlogCategoryResource>>(`/admin/blog-categories/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const careerJobsApi = {
  ...
  create: (data: StoreCareerJobRequest) => adminFetch<ApiResponse<CareerJobResource>>("/admin/jobs", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: UpdateCareerJobRequest) => adminFetch<ApiResponse<CareerJobResource>>(`/admin/jobs/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const departmentsApi = {
  ...
  create: (data: StoreDepartmentRequest) => adminFetch<ApiResponse<DepartmentResource>>("/admin/departments", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: Partial<StoreDepartmentRequest>) => adminFetch<ApiResponse<DepartmentResource>>(`/admin/departments/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const caseStudiesApi = {
  ...
  create: (data: StoreCaseStudyRequest) => adminFetch<ApiResponse<CaseStudyResource>>("/admin/case-studies", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: UpdateCaseStudyRequest) => adminFetch<ApiResponse<CaseStudyResource>>(`/admin/case-studies/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const caseStudyTagsApi = {
  ...
  create: (data: StoreCaseStudyTagRequest) => adminFetch<ApiResponse<CaseStudyTagResource>>("/admin/case-study-tags", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: StoreCaseStudyTagRequest) => adminFetch<ApiResponse<CaseStudyTagResource>>(`/admin/case-study-tags/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const sectorsApi = {
  ...
  create: (data: StoreSectorRequest) => adminFetch<ApiResponse<SectorResource>>("/admin/sectors", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: UpdateSectorRequest) => adminFetch<ApiResponse<SectorResource>>(`/admin/sectors/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const technologiesApi = {
  ...
  create: (data: StoreTechnologyRequest) => adminFetch<ApiResponse<TechnologyResource>>("/admin/technologies", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: Partial<StoreTechnologyRequest>) => adminFetch<ApiResponse<TechnologyResource>>(`/admin/technologies/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const technologyCategoriesApi = {
  ...
  create: (data: StoreTechnologyCategoryRequest) => adminFetch<ApiResponse<TechnologyCategoryResource>>("/admin/technology-categories", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: StoreTechnologyCategoryRequest) => adminFetch<ApiResponse<TechnologyCategoryResource>>(`/admin/technology-categories/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const leadershipApi = {
  ...
  create: (data: StoreLeadershipMemberRequest) => adminFetch<ApiResponse<LeadershipMemberResource>>("/admin/leadership-members", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: Partial<StoreLeadershipMemberRequest>) => adminFetch<ApiResponse<LeadershipMemberResource>>(`/admin/leadership-members/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const companyValuesApi = {
  ...
  create: (data: StoreCompanyValueRequest) => adminFetch<ApiResponse<CompanyValueResource>>("/admin/company-values", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: StoreCompanyValueRequest) => adminFetch<ApiResponse<CompanyValueResource>>(`/admin/company-values/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const companyCapabilitiesApi = {
  ...
  create: (data: StoreCompanyCapabilityRequest) => adminFetch<ApiResponse<CompanyCapabilityResource>>("/admin/company-capabilities", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: StoreCompanyCapabilityRequest) => adminFetch<ApiResponse<CompanyCapabilityResource>>(`/admin/company-capabilities/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const expertiseRolesApi = {
  ...
  create: (data: StoreExpertiseRoleRequest) => adminFetch<ApiResponse<ExpertiseRoleResource>>("/admin/expertise-roles", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: StoreExpertiseRoleRequest) => adminFetch<ApiResponse<ExpertiseRoleResource>>(`/admin/expertise-roles/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const metricsApi = {
  ...
  create: (data: StoreMetricRequest) => adminFetch<ApiResponse<MetricResource>>("/admin/metrics", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: StoreMetricRequest) => adminFetch<ApiResponse<MetricResource>>(`/admin/metrics/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
...
export const whyChooseUsApi = {
  ...
  create: (data: StoreWhyChooseUsItemRequest) => adminFetch<ApiResponse<WhyChooseUsItemResource>>("/admin/why-choose-us", { method: "POST", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
  update: (id: number, data: StoreWhyChooseUsItemRequest) => adminFetch<ApiResponse<WhyChooseUsItemResource>>(`/admin/why-choose-us/${id}`, { method: "PUT", body: JSON.stringify(cleanPayload(data)) }).then(r => r.data),
